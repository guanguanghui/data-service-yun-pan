...
public interface FileService {
	...
	String pretendImportFolder(final HttpServletRequest request);

	String pretendUploadFile(final HttpServletRequest request, final HttpServletResponse response);

	String deleteFile(final HttpServletRequest request);

	String reallyDeleteFile(final HttpServletRequest request);
	...
	String fakerDeleteCheckedFiles(final HttpServletRequest request);

	String getPackTime(final HttpServletRequest request);

	String getFileOccupancySpace(final HttpServletRequest request);

	String getFileIsUpLoaded(final HttpServletRequest request);
	...
	String confirmRestoreFiles(final HttpServletRequest request);
