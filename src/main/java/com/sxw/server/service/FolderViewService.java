 ...
 * 该服务层用于查询、拼装、处理文件夹视图的相关请求，是sxwpan核心功能的主要组成之一。
 * </p>
 * @author ggh@sxw.cn
 * @version 1.0
 */
public interface FolderViewService{
     ...
     * @return java.lang.String 该文件夹视图的JSON格式，原型详见com.sxw.server.pojo.SreachView类。
     */
     ...
     * @return java.lang.String 该文件夹后续视图的JSON格式，原型详见com.sxw.server.pojo.RemainingFolderView类。
     */
